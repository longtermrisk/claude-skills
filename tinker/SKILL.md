---
name: tinker
description: Reference guide for the Tinker training API for large language models, including async workflows, training and sampling, loss functions, save/load, rendering, and client/type APIs. Use when implementing Tinker API calls, consulting Tinker docs, or troubleshooting Tinker model training and sampling integrations.
---
...
- save-load.mdx
- rendering.mdx
- api-reference/trainingclient.md
- api-reference/serviceclient.md
- api-reference/samplingclient.md
- api-reference/types.md

**Available but not included (fetch from GitHub using the URL pattern above):**
- api-reference/apifuture.md
- api-reference/exceptions.md
- api-reference/restclient.md
- compatible-apis/openai.mdx
- completers.mdx
- dev-tips.mdx
...
- preferences.mdx
- preferences/dpo-guide.mdx
- preferences/rlhf-example.mdx
- publish-weights.mdx
- rl.mdx
- rl/rl-basic.mdx
- rl/rl-envs.mdx
- rl/rl-hyperparams.mdx
- rl/rl-loops.mdx
- rl/sequence-extension.mdx
- supervised-learning.mdx
- supervised-learning/prompt-distillation.mdx
- supervised-learning/sl-basic.mdx
- supervised-learning/sl-hyperparams.mdx
- supervised-learning/sl-loop.mdx
- supervised-learning/sweep-case-study.mdx
- under-the-hood.mdx
...
*[Section "How forward_backward_custom works" removed for brevity. See the full documentation for implementation details.]*
...
*[Appendix removed for brevity. See full documentation for discussion of why Tinker uses custom renderers instead of Jinja templates.]*
